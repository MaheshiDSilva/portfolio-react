        ...
        <section id="portfolio">
            <div className="container">
                           ...
                           <div key={index} data-aos="fade-zoom-in" data-aos-delay="50" data-aos-duration="1000" className="group max-w-full sm:w-[48.5%] md:w-[31.8%] lg:w-[32.2%] relative z-[1]">
                               ...
                               <div className="w-full h-full bg-primaryColor bg-opacity-40 absolute top-0 left-0 z-[5]
                                ...
                                <div className="w-full h-full flex items-center justify-center">
                                    ...
                                    rounded-[8px] font-[500] ease-in duration-200">See Details
                                    </button>
                                </div>
                               </div>
                           </div>
                ...
                <div className="text-center mt-6">
                    ...
                    <button onClick={lordMoreHandler} className="text-white bg-headingColor hover:bg-smallTextColor py-2 px-4
                      rounded-[8px] font-[500] ease-in duration-200">Load More
                    </button>
                        )}
                </div>
            </div>
